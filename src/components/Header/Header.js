        ...
        <div>
            <nav className="border-gray-200 px-2 py-2.5 bg-gray-800">
                <div className="container flex flex-wrap justify-between items-center mx-auto">
                    ...
                    <div className={`absolute ${open ? 'top-14 right-0 left-0' : 'top-[-300px] right-0 left-0'} duration-200 ease-linear bg-gray-800 overflow-hidden w-full md:w-auto md:static`} id="mobile-menu">
